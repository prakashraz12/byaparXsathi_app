...
export const shopSchema = z.object({
    ...
    phoneNumber: z.string().min(10, "Phone number must be at least 10 characters long").or(z.literal("")),
    address: z.string().min(5, "Address must be at least 5 characters long"),
    panNumber: z.string().min(5, "Pan number must be at least 5 characters long").or(z.literal("")),
    registrationNumber: z.string().min(5, "Registration number must be at least 5 characters long").or(z.literal("")),
