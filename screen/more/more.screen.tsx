...
export const MoreScreen = () => {
  ...
  const handleShareApp = async (): Promise<void> => {
    try {
      const result = await Share.share({
        message: 'Check out this amazing app! Download it now: https://your-app-link.com',
        title: 'Share App',
      });
    } catch (error) {
  ...
  const handleLegalNavigation = async (type: 'privacy' | 'terms'): Promise<void> => {
    try {
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
            ...
            <View style={styles.cardContent}>
              <View style={styles.leftContent}>
                ...
                <View style={styles.textContainer}>
                  ...
                  <Text style={styles.cardSubtitle}>Manage your business information</Text>
                </View>
              </View>
              <Ionicons name="chevron-forward" size={20} color="#C7C7CC" />
            </View>
            ...
            <View style={styles.cardContent}>
              <View style={styles.leftContent}>
                ...
                <View style={styles.textContainer}>
                  ...
                  <Text style={styles.cardSubtitle}>Notifications, privacy, and more</Text>
                </View>
              </View>
              <Ionicons name="chevron-forward" size={20} color="#C7C7CC" />
            </View>
          ...
          <TouchableOpacity style={styles.card} onPress={handleRateApp} activeOpacity={0.7}>
            <View style={styles.cardContent}>
              <View style={styles.leftContent}>
                <View style={[styles.iconContainer, { backgroundColor: '#FFD60A15' }]}>
                  <Ionicons name="star-outline" size={24} color="#FFD60A" />
                </View>
                <View style={styles.textContainer}>
                  <Text style={styles.cardTitle}>Rate App</Text>
                  <Text style={styles.cardSubtitle}>Rate us on the App Store</Text>
                </View>
              </View>
              <Ionicons name="chevron-forward" size={20} color="#C7C7CC" />
            </View>
          ...
          <TouchableOpacity style={styles.card} onPress={handleShareApp} activeOpacity={0.7}>
            <View style={styles.cardContent}>
              <View style={styles.leftContent}>
                <View style={[styles.iconContainer, { backgroundColor: '#32D74B15' }]}>
                  <Ionicons name="share-outline" size={24} color="#32D74B" />
                </View>
                <View style={styles.textContainer}>
                  <Text style={styles.cardTitle}>Share App</Text>
                  <Text style={styles.cardSubtitle}>Share with friends and family</Text>
                </View>
              </View>
              <Ionicons name="chevron-forward" size={20} color="#C7C7CC" />
            </View>
        ...
        <View style={styles.footer}>
          <View style={styles.footerContent}>
            <View style={styles.logoContainer}>
              <Text style={styles.companyText}>Product of Hobby Tech Solutions © 2024</Text>
            </View>

            <View style={styles.legalContainer}>
              <TouchableOpacity onPress={() => handleLegalNavigation('privacy')}>
